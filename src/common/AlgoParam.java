...
public class AlgoParam {
    ...
    public String process_time_input;
    public String work_order_input;
    public String path_data;
    public String path_result_sol;
    public String path_result_csv;

    public AlgoParam(String problem_name, String author_id, String author_name, String algo_name, int time_limit, String process_time_input, String work_order_input, String path_data){
        this.problem_name = problem_name;
        this.author_id = author_id;
        this.author_name = author_name;
        this.algo_name = algo_name;
        this.time_limit = time_limit;
        this.process_time_input = process_time_input;
        this.work_order_input = work_order_input;
    ...
    public void initial_result_csv(){
        try{
            ...
            Log.start(csv, false);
            Log.writeln("problem_name,author_id,author_name,algo,sol,time");
            Log.end();
